...
then
 ...
 secretd keys add a
  ...
  secretd add-genesis-account $PLAYER1_ADDR 2000000000000000000uscrt
  secretd add-genesis-account $PLAYER2_ADDR 2000000000000000000uscrt
  secretd add-genesis-account $PLAYER3_ADDR 2000000000000000000uscrt
  secretd add-genesis-account $PLAYER4_ADDR 2000000000000000000uscrt
  secretd add-genesis-account $PLAYER5_ADDR 2000000000000000000uscrt
  secretd add-genesis-account $PLAYER6_ADDR 2000000000000000000uscrt
  secretd add-genesis-account $PLAYER7_ADDR 2000000000000000000uscrt
  secretd add-genesis-account $PLAYER8_ADDR 2000000000000000000uscrt
  secretd add-genesis-account $PLAYER9_ADDR 2000000000000000000uscrt
  secretd add-genesis-account $PLAYER10_ADDR 2000000000000000000uscrt
